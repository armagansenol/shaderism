...
import { Effect, PixelationEffect } from "postprocessing"
...
const GlitchPostEffect = forwardRef<GlitchEffect, GlitchParams>((props, ref) => {
  const effectRef = useRef<GlitchEffect>(null!)
  ...
  return (
    <>
      <primitive ref={effectRef} object={effect} />
      <primitive object={pixelationEffect} />
    </>
  )
})

GlitchPostEffect.displayName = "GlitchPostEffect"

export { GlitchPostEffect, GlitchEffect }
